...
using Jellyfin.Server.Implementations.Achievements;
using Jellyfin.Server.Implementations.Activity;
using Jellyfin.Server.Implementations.ContentRequests;
using Jellyfin.Server.Implementations.Devices;
using Jellyfin.Server.Implementations.Events;
using Jellyfin.Server.Implementations.Extensions;
using Jellyfin.Server.Implementations.AppDownload;
using Jellyfin.Server.Implementations.FeatureAnnouncements;
using Jellyfin.Server.Implementations.Leaderboard;
...
namespace Jellyfin.Server
{
    ...
    public class CoreAppHost : ApplicationHost
    {
        ...
        protected override void RegisterServices(IServiceCollection serviceCollection)
        {
            ...
            serviceCollection.AddSingleton<IAppDownloadService, AppDownloadService>();
            serviceCollection.AddSingleton<IFeatureAnnouncementService, FeatureAnnouncementService>();
