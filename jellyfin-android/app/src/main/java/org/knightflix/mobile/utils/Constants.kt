package org.knightflix.mobile.utils
...
object Constants {
    ...
    const val FRAGMENT_CONNECT_EXTRA_ERROR = "org.knightflix.mobile.intent.extra.ERROR"
    const val FRAGMENT_WEB_VIEW_EXTRA_SERVER = "org.knightflix.mobile.intent.extra.SERVER"
    ...
    const val MEDIA_NOTIFICATION_CHANNEL_ID = "org.knightflix.mobile.media.NOW_PLAYING"
    const val DOWNLOAD_NOTIFICATION_CHANNEL_ID = "org.knightflix.mobile.download.DOWNLOAD_PROGRESS"
    const val CONTENT_REQUEST_NOTIFICATION_CHANNEL_ID = "org.knightflix.mobile.request.CONTENT_READY"
    ...
    const val ACTION_SHOW_PLAYER = "org.knightflix.mobile.intent.action.SHOW_PLAYER"
    const val ACTION_PLAY = "org.knightflix.mobile.intent.action.PLAY"
    const val ACTION_PAUSE = "org.knightflix.mobile.intent.action.PAUSE"
    const val ACTION_REWIND = "org.knightflix.mobile.intent.action.REWIND"
    const val ACTION_FAST_FORWARD = "org.knightflix.mobile.intent.action.FAST_FORWARD"
    const val ACTION_PREVIOUS = "org.knightflix.mobile.intent.action.PREVIOUS"
    const val ACTION_NEXT = "org.knightflix.mobile.intent.action.NEXT"
    const val ACTION_STOP = "org.knightflix.mobile.intent.action.STOP"
    const val ACTION_REPORT = "org.knightflix.mobile.intent.action.REPORT"
    ...
    const val EXTRA_MEDIA_PLAY_OPTIONS = "org.knightflix.mobile.MEDIA_PLAY_OPTIONS"
    const val EXTRA_REQUEST_CONTENT_ITEM_ID = "org.knightflix.mobile.REQUEST_CONTENT_ITEM_ID"
