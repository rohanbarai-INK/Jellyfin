...
type CreateUserWithSubscription = CreateUserByName & {
    InitialSubscriptionDurationMonths?: number;
};
...
const UserNew = () => {
    ...
    const optionInitialSubscriptionDuration = () => {
        let content = '';
        content += `<option value=''>No Initial Subscription</option>`;
        content += `<option value='1'>1 month</option>`;
        content += `<option value='3'>3 months</option>`;
        content += `<option value='6'>6 months</option>`;
        content += `<option value='12'>12 months</option>`;
        return content;
    };
    ...
    useEffect(() => {
        ...
        const saveUser = () => {
            const selectedInitialDuration = (page.querySelector('#selectInitialSubscriptionDuration') as HTMLSelectElement).value;
            const initialDurationMonths = selectedInitialDuration ? parseInt(selectedInitialDuration, 10) : undefined;

            const userInput: CreateUserWithSubscription = {
            ...
            if (initialDurationMonths) {
                userInput.InitialSubscriptionDurationMonths = initialDurationMonths;
            }
        ...
        >
            ...
            <div ref={element} className='content-primary'>
                ...
                <form className='newUserProfileForm'>
                    ...
                    <div className='inputContainer'>
                        <SelectElement
                            id='selectInitialSubscriptionDuration'
                            label='Initial Subscription Duration'
                        >
                            {optionInitialSubscriptionDuration()}
                        </SelectElement>
                    </div>
                    <AccessContainer
